...
const Newssideblog = ({newBlog}) => {
    ...
    return (
        ...
        <p className="font-medium mt-5">Bookmarked Blogs :{newBlog.length}</p>
        <div className=" p-3 bg-white rounded-xl mt-2">
           
            <p className="text-sm">Master Microsoft Power Platform and Become an In-Demand!</p>
